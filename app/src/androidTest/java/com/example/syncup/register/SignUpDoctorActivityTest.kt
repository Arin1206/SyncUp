...
class SignUpDoctorActivityTest {
    ...
    @After
    fun tearDown() {
        // Release Intents after every test to avoid IllegalStateException
    ...
    fun registerWithFirestore_shouldRejectEmptyPhoneNumber() {
        ...
        ActivityScenario.launch(SignUpDoctorActivity::class.java).use { scenario ->
            ...
            scenario.onActivity { activity ->
                ...
                activity.binding.edRegisFullname.setText("Dr. John Doe")
                activity.binding.edRegisPhone.setText("") // Phone number is empty
                activity.binding.edRegisAge.setText("35") // Age is filled
    ...
    fun registerWithFirestore_shouldRejectEmptyAgeWhenOtherFieldsAreFilled() {
        ...
        ActivityScenario.launch(SignUpDoctorActivity::class.java).use { scenario ->
            ...
            scenario.onActivity { activity ->
                ...
                activity.binding.edRegisFullname.setText("Dr. John Doe")  // Full Name is filled
                activity.binding.edRegisPhone.setText("08988888")  // Phone number is filled
    ...
    fun registerWithFirestore_shouldAcceptValidInputs() {
        ...
        ActivityScenario.launch(SignUpDoctorActivity::class.java).use { scenario ->
            ...
            scenario.onActivity { activity ->
                ...
                activity.binding.edRegisAge.setText("35")  // Age is valid
